<html>
<head>
<title>Intermediate Group Lessons Sign Up</title>
...
<h2 class="brown">Group Intermediate Sign Up</h2>

<form name="intermediate_add" action="add_student.php" method="post">
<input type="hidden" name="skill" value="intermediate">
...
$select = "SELECT id, name, start, end, size, day FROM schedule WHERE skill = 'intermediate' AND type = 'group'";
